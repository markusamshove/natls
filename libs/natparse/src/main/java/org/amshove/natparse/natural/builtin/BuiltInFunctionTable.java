...
public class BuiltInFunctionTable
{
	...
	static
	{
		TABLE = Map.ofEntries(
			...
			function(SyntaxKind.SV_PARSE_NAMESPACE_URI, "Contains the namespce URI of the current XML node", ALPHANUMERIC, DataType.DYNAMIC_LENGTH, labelParameter(false)),
