...
class LexerForKeywordsShould extends AbstractLexerTest
{
	...
	Iterable<DynamicTest> lexKCheckReservedKeywords()
	{
		return Arrays.asList(
			...
			keywordTest("JSON", SyntaxKind.JSON),
			...
			keywordTest("LANGUAGE", SyntaxKind.SV_LANGUAGE),
			...
			keywordTest("LOG-LS", SyntaxKind.SV_LOG_LS),
			keywordTest("LOG-PS", SyntaxKind.SV_LOG_PS),
			...
			keywordTest("PROGRAM", SyntaxKind.SV_PROGRAM),
			...
			keywordTest("SEPARATOR", SyntaxKind.SEPARATOR),
			...
			keywordTest("SUBCODE", SyntaxKind.SUBCODE),
